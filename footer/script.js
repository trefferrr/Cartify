function Footer(){
    ...
    <div id="links1">
        <div class="online">
            ...
            <br>
            <button class="sub1" onclick="subway4()" >CARTIFY Insider <sup style="color: white;background-color: red;">New</sup></button>
        </div>
        <div class="online">
            <p>USEFUL LINKS</p>
        ...
        <div id="social">
            <p>EXPERIENCE CARTIFY APP ON MOBILE</p>
        ...
        <div id="firstlast">
            <div id="ori1">
                ...
                <p>100% ORIGINAL guarantee for all products at cartify.com</p>
            </div>
            <div id="ret1">
    ...
    <div id="popular1">
        ...
        <p>
            Makeup | Dresses For Girls | T-Shirts | Sandals | Headphones | Babydolls | Blazers For Men | Handbags | Ladies Watches | Bags | Sport Shoes | Reebok Shoes | Puma Shoes | Boxers | Wallets | Tops | Earrings | Fastrack Watches | Kurtis | Nike | Smart Watches | Titan Watches | Designer Blouse | Gowns | Rings | Cricket Shoes | Forever 21 | Eye Makeup | Photo Frames | Punjabi Suits | Bikini | Cartify Fashion Show | Lipstick | Saree | Watches | Dresses | Lehenga | Nike Shoes | Goggles | Bras | Suit | Chinos | Shoes | Adidas Shoes | Woodland Shoes | Jewellery | Designers Sarees
        </p>
    </div>
    <div id="contact1">
        ...
        <div>© 2022 www.cartify.com. All rights reserved.</div>
    </div>
</div>`
}
export {Footer};
...
function mainFooter(){
    ...
    <div id="links1">
        <div class="online">
            ...
            <br>
            <button class="sub1 fotterButtons"  >CARTIFY Insider <sup style="color: white;background-color: red;">New</sup></button>
        </div>
        <div class="online">
            <p>USEFUL LINKS</p>
    ...
    <div id="popular1">
        ...
        <p class="peraFontSize">
            Makeup | Dresses For Girls | T-Shirts | Sandals | Headphones | Babydolls | Blazers For Men | Handbags | Ladies Watches | Bags | Sport Shoes | Reebok Shoes | Puma Shoes | Boxers | Wallets | Tops | Earrings | Fastrack Watches | Kurtis | Nike | Smart Watches | Titan Watches | Designer Blouse | Gowns | Rings | Cricket Shoes | Forever 21 | Eye Makeup | Photo Frames | Punjabi Suits | Bikini | Carify Fashion Show | Lipstick | Saree | Watches | Dresses | Lehenga | Nike Shoes | Goggles | Bras | Suit | Chinos | Shoes | Adidas Shoes | Woodland Shoes | Jewellery | Designers Sarees
        </p>
    </div>
    <div id="contact1">
        <div style="display: flex">
